# Puppet Bolt Team Intership Technical Challenge, Summer 
## Single ouput report on multiple server nodes 

A program that fulfills the specifications for a technical challenge requested by the Puppet Bolt Team as part of the application process for a Summer 2018 internship.  
...
## Technical challenge decription 
